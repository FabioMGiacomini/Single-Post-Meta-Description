...
function single_post_meta_description_admin_enqueue_stylesheet(){
  wp_enqueue_style( 'spmd-style', plugins_url( 'admin/css/mtd-style.css', dirname(__FILE__ ) ) );
}
...
add_action('admin_init', 'viarete_spmd_registro_opzioni');
function viarete_spmd_registro_opzioni(){
